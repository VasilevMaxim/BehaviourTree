...
public class WaypointsDrawer
{
    ...
    public void Move(Vector2 scale, Vector2 position)
    {
        ...
        if (_count == 3)
        {
            ...
            Waypoints[0].Position = _positionDown + _scaleSelectZone / 2;
            Waypoints[1].Position = _positionRight + _scaleSelectZone / 2;
            Waypoints[2].Position = _positionLeft + _scaleSelectZone / 2;
